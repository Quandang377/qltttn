...
// Lấy danh sách giáo viên và số sinh viên đã phân công
$stmt = $conn->prepare("
    SELECT GV.ID_TaiKhoan, GV.Ten, COUNT(SV.ID_TaiKhoan) AS SoLuong
    FROM giaovien GV
    LEFT JOIN sinhvien SV ON GV.ID_TaiKhoan = SV.ID_GVHD AND SV.ID_Dot = :id
...
if (isset($_GET['ajax_tab']) && $_GET['ajax_tab'] == 'gv') {
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Danh sách giáo viên hướng dẫn</div>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="dot-header panel panel-default" style="padding:24px 18px 10px 18px;">
                    ...
                    <div class="dot-actions" style="margin-top:12px;">
                        <button onclick="window.location='pages/canbo/importexcel?id=<?= $id ?>';"
                            class="btn btn-primary btn-md" <?= $dot['TrangThai'] != 1 ? 'disabled' : '' ?>>Import sinh
                            viên</button>
                        <button type="button" class="btn btn-primary btn-md" id="btnMoModalThemGV" <?= $dot['TrangThai'] != 1 ? 'disabled' : '' ?>>
                            Thêm giáo viên
                        </button>
                ...
                <ul class="nav nav-tabs" id="tabDotThucTap">
                    <li class="active"><a href="#tab-gv" data-toggle="tab" data-tab="gv">Giáo viên hướng dẫn</a></li>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="chonGVCoSan"><b>Chọn giáo viên cho đợt (giữ Ctrl hoặc Shift để chọn
                                        nhiều):</b></label>
                                <select multiple class="form-control" id="chonGVCoSan" name="gvCoSan[]" size="8"
                            ...
                            <hr>
                            <div class="form-group">
                                <label>Hoặc thêm giáo viên mới</label>
