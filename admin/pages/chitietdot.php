        ...
        <div class="panel-heading">
            <div class="row" style="margin-bottom: 15px;">
                ...
                <div class="col-md-8" style="text-align: right;">
                    <button onclick="window.location.href='admin/pages/chitietdot?id=<?= $id ?>&export_excel=1'"
                        class="btn btn-success">
                        <i class="fa fa-file-excel-o"></i> Xuất danh sách phân công
                    </button>
                    <button onclick="window.location.href='admin/pages/chitietdot?id=<?= $id ?>&export_excel=2'"
                        class="btn btn-success">
...
<body>
    ...
    <script>
        function capNhatNutPhanCong(idDot) {
            $.post('/datn/admin/pages/ajax_get_phancong_mode.php', { id_dot: idDot }, function (res) {
